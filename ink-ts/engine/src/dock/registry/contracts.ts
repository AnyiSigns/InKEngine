...
import { entity_evolution_contract } from '../../kernel/entity_evolution/contract.js';
import { evolution_contract } from '../../kernel/evolution/contract.js';
import { evolution_writer_contract } from '../../kernel/evolution_writer/contract.js';
import { executor_contract } from '../../graph/executor/contract.js';
import { growth_contract } from '../../kernel/growth/contract.js';
import { interrupt_contract } from '../../kernel/interrupt/contract.js';
import { introspection_contract } from '../../kernel/introspection/contract.js';
import { knowledge_gate_contract } from '../../kernel/knowledge_gate/contract.js';
import { llm_contract } from '../../kernel/llm/contract.js';
import { memory_extract_contract } from '../../kernel/memory_extract/contract.js';
...
import { recovery_contract } from '../../kernel/recovery/contract.js';
import { round_steps_contract } from '../../kernel/round_steps/contract.js';
import { runtime_contract } from '../../kernel/runtime/contract.js';
import { sandbox_contract } from '../../gate/sandbox/contract.js';
import { self_application_contract } from '../../kernel/self_application/contract.js';
import { self_proposal_contract } from '../../kernel/self_proposal/contract.js';
import { self_tools_contract } from '../../kernel/self_tools/contract.js';
import { settle_contract } from '../../kernel/settle/contract.js';
import { simulation_contract } from '../../kernel/simulation/contract.js';
import { skill_crystal_contract } from '../../kernel/skill_crystal/contract.js';
import { spawn_contract } from '../../kernel/spawn/contract.js';
import { tool_pipeline_contract } from '../../kernel/tool_pipeline/contract.js';
import { tool_vetting_contract } from '../../gate/tool_vetting/contract.js';
import { tuning_contract } from '../../kernel/tuning/contract.js';
