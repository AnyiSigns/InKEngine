...
export { DeterministicDistiller, DistillConfig, DistillOutcome } from '../distill/distill.js';
export type { Distiller } from '../distill/distill.js';
export { RoleDistiller, resolve_distill_chain } from '../distill/distill_role.js';
export { ReuseDecision, reuse_or_distill } from '../distill/reuse.js';
export {
  buildPrecisePatch as build_precise_patch,
} from '../../../core/knowledge_set/knowledge_set_core.js';
