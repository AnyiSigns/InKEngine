...
import type { EvolutionWriter } from '../../proposal/evolution_writer/_types.js';
import { SignalClassifier } from '../../learn/signals/signals.js';
import type { ExecutionSignal } from '../../learn/signals/signals.js';
import {
  LEVEL_PROJECT,
  LEVEL_USER,
  LEVEL_WORK,
