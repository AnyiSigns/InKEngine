/**
 * 自指层应用管线公开面（kernel/self_application.py __all__ 镜像）。
 *
...
} from '../../proposal/constants.js';

export { GuardedStorage } from '../../proposal/guarded_storage.js';
export type { GuardedStorageInit, MechanismExemptionScope } from '../../proposal/guarded_storage.js';
