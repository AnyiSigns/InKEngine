/**
 * 自指应用管线（kernel/self_application.py SelfApplicationPipeline 移植）：
 * 提案 → 校验 → 分级审批 → 落链 → 应用 → 审计。
 *
...
import { _APPROVAL_KEY_PREFIX, _SET_AUDIT_COLLECTION } from '../../proposal/constants.js';
import { _PatchApprovalPolicy } from './approval_policy.js';
import { GuardedStorage } from '../../proposal/guarded_storage.js';
