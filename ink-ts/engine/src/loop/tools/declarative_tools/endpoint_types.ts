 ...
 */
import { BUILTIN_ENDPOINT_NAMES, BUILTIN_ENDPOINTS } from '../../../model/contracts/generated/index.js';
import { GraphDefinitionError } from '../../../model/errors.js';
import { EndpointType, type EndpointTypeValue } from '../../../model/endpoints.js';
...
// P6 归位（动作 F）：内置端点枚举常量 / 值联合 / 编译期集合绑定已下移
// model/endpoints.ts（数据面单源邻接 generated），本处 re-export 保链。
export { EndpointType };
export type { EndpointTypeValue };
