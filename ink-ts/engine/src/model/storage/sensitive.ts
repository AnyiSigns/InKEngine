// P6 归位（引擎重排计划 §6 P6 动作 C）：strip_sensitive 族自 gate/security/security.ts
// 整体下移 model——storage_records/adapters 数据面消费，非闸门裁决逻辑；
// gate/security/security.ts 保留原样 re-export（消费者路径不变）。
/**
