...
export const SETTINGS_SECTIONS: SettingsSectionEntry[] = [
  ...
  { id: 'mcp_market', type: 'mcp_market', key: 'mcp_market', label: 'MCP 市场', order: 10, icon: 'server' },
  { id: 'tools_panel', type: 'tools_panel', key: 'tools_panel', label: '工具', order: 20, icon: 'wrench' },
