/**
 * model_archive.snapshot 命令逻辑面 —— S3 命令逻辑下沉（hosts/lib/src/bridge/
 * model_archive.ts 迁入，语义零改）。模型档案快照（从**运行 model_config** 聚合，
 * 能力优先级：显式配置 > models.dev 快照 > 厂商 /models > 手工目录）。
 */
...
} from '../../../_shared/model_catalog.js';
import { fetchModelsDevCatalog, lookupModelsDevCapability } from '../../../_shared/model_modelsdev.js';
import { matchReasoningCatalog } from '../../../_shared/reasoning_catalog.js';
...
export default function createModelArchiveSnapshot(deps: HostBridgeDeps): BridgeHandler {
