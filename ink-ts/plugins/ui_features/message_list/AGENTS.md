...
- bind：state.messages（会话消息流）；chrome 读面：roundSteps/incubation/patchChain/spawnInstances/task/streaming/onBranchFromMessage 等按消息类型消费（旧 simulations 通道随推演机制 P8+S1 退役删除）。
